...
<table>
    ...
    <tr>
        <td class="fieldcontain ${hasErrors(bean: menu, field: 'classifyName', 'error')} required">菜谱分类</td>
        <td><g:textField name="classifyName" style="width:480px" required="" value="${menu?.classifyName}"/></td>
    </tr>
    <tr>
