...
<html>
    ...
    <div class="content">
        ...
        <div class="conmain">
            <a class="botton" href="create">新增酒店</a>
        </div>
        <div class="conmain">
            <strong class="Orange">
        ...
        <div class="conmain">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr class="tbbg">
                    <td width="20%" align="center"><strong>酒店名称</strong></td>
                    ...
                    <td width="20%" align="center"><strong>管理房间</strong></td>
                    <td width="20%" align="center"><strong>操作</strong></td>
                </tr>
				<g:each in="${hotelInstanceList}" status="i" var="hotelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						<td><g:link action="edit" id="${hotelInstance.id}">${fieldValue(bean: hotelInstance, field: "hotelName")}</g:link></td>
                        <td>${fieldValue(bean: hotelInstance, field: "hotelOwner")}</td>
                        <td>${fieldValue(bean: hotelInstance, field: "telephone")}</td>
                        <td>${g.formatDate(date:hotelInstance.createDate, format: 'yyyy-MM-dd')}</td>
                        <td><g:link action="listRoom" id="${hotelInstance.id}" class="delete" >房间管理</g:link></td>
                        <td>
                            <g:form url="[resource:hotelInstance, action:'delete']" method="POST" >
