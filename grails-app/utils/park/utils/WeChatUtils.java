...
import static park.utils.WeiAPI.APP_SECRET;
...
public class WeChatUtils {
    ...
    public static AuthToken getTokenByAuthCode(String code){
        ...
        try {
            URL url = new URL(WeChatConstant.GET_AUTHTOKEN_URL+"appid="+ WeChatConfig.getInstance().getAppID()+"&secret="+ APP_SECRET+"&code="+code+"&grant_type=authorization_code");
            ...
            authToken = new Gson().fromJson(json.toString(),AuthToken.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return authToken;
    ...
    public static String getSign(SortedMap<String,Object> map){
        ...
        try {
            sb.append("key=" + WeChatConfig.getInstance().getKey());
        } catch (Exception e) {
            e.printStackTrace();
        }
        String result = null;
        try {
            result = WXPayUtil.MD5(sb.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
