...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'park.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'park.UserRole'
grails.plugin.springsecurity.authority.className = 'park.Role'
...
grails {
    plugin {
        springsecurity {
            ...
            active = true
            userLookup.userDomainClassName = "park.User"
            authority.className = "park.User"
